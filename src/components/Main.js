...
const Main = () => (
  <Container
    ...
    <hr />
    <p>
      <b>A 2016 júniusi Brexit népszavazás</b> óta eltelt több mint három évben az Egyesült Királyság politikai életét az <b>EU-ból való kilépés és annak feltételei</b>, megvalósítása határozták meg. Több kormányváltást, két előrehozott választást, és a hivatalos kilépési határidő többszöri meghosszabbítását is láttuk, és még koránt sincs vége.
    </p>

    <h3>Miért ilyen hosszadalmas ez a folyamat? </h3>
    <hr />
    <p>
      Elsősorban kettő tényező miatt. Egyrészt, <b>a brit kormánynak ténylegesen bonyolult kérdésekről kell megegyezni az Európai Unióval</b>. Az EU tagjaként az áruk, szolgáltatások és munkaerő szabadon és vámmentesen áramlott az Egyesült Királyság és az Unió között, illetve a közös jogszabályi háttér is biztosított volt. A kilépéssel azonban meg kell egyezni az új kereskedelmi feltételekről, a szabályozói környezetről, illetve az Észak-Írország (Egyesült Királyság része) és Írország (független ország, EU tagja) határát érintő kérdésekről. A szigetország számára ez utóbbi különösen súlyos kérdés, hiszen nem sokkal, alig több, mint 20 évvel ezelőtt, még <a href="https://index.hu/nagykep/2018/11/15/az_eszakir_konfliktus_50_evvel_kesobb/" target="_blank">ember életeket követelő konfliktus zajlott Észak-Írország státuszát illetően</a>.
    </p>
    <p>
      A másik nagy akadály a gyors kilépés előtt az, hogy a kormánynak, ha meg is állapodik az EU-val, a hazai politikában is meg kell szereznie a támogatást a megegyezés feltételei mellett. Theresa May, korábbi miniszterelnök például meg tudott egyezni a kilépés fő kérdéseiről az Unióval, de a parlament többször is elutasította a megállapodást. Sokat elmond a helyzet komplexitásáról, hogy 2019 tavaszán a parlament úgynevezett indikatív szavazást tartott 8 különböző kilépési elképzelésről (vámunióban maradás, megegyezés nélküli kilépés, stb.), és a képviselők egyenként leszavazták az összes indítványt. Számos parlamenti csoportosulás alakult ki a Brexit kérdései körül és a különböző csoportok eltérő okokra hivatkozva utasítottak el minden konkrét javaslatot. <b>A korábbi parlamenti arányok mellett nehéz volt bármilyen komplett elképzelésnek többségi támogatást szerezni</b>, így érthető, hogy a kilépési folyamat miért húzódott el egyre jobban.
    </p>

    <h3>De mégis, miért nem tud az ország csak egyszerűen kilépni megegyezés nélkül?</h3>
    <hr />
    <p>
      <b>A megegyezés nélküli kilépés várhatóan nagyon komoly károkat okozna a szigetország gazdaságában, hiszen a brit cégek erősen integráltak az EU gazdasági vérkeringésében</b>, ezért azt a képviselők eddig nem támogatták, ahogy a brit közvélemény sem. A gazdasági károkról még annyit, hogy az elmúlt évek bizonytalansága már eddig is lenyomta a növekedést, elsősorban  a céges beruházások visszatartása és a kereskedelem csökkenése miatt. Ennek mértékéről eltérő elemzések vannak, viszont az például egyértelműen látható hogy a font sokat veszített értékéből.
    </p>

    <h3>Mi a legfrissebb fejlemény?</h3>
	  <hr />
    <p>
      <b>Boris Johnson miniszterelnök kormánya és az EU 2019 őszén megállapodott egy új egyezményben</b>, amit a brit parlament ugyan nagy vonalakban elfogadott, de több időt kértek, hogy azt részleteiben is meg tudják vitatni. Így a parlament által erre kötelezett brit kormány az október 31-i határidő meghosszabbítását kérte az EU-tól, amit az európai tagállamok vétó nélkül elfogadtak, és január 31-ét tűzték ki új hivatalos kilépési határidőként.
      A miniszterelnök látva hogy a Brexit megállapodást nem tudja gyorsan és gördülékenyen törvénybe iktatni, stratégiát váltott, és <b>előrehozott választások</b> ötletét terjesztette a parlament elé. A parlament elfogadta ezt az indítványt, így a <b>britek december 12-én általános népszavazáson döntöttek a képviselői helyek sorsáról</b>. Boris Johnson számításai beigazolódtak, ugyanis a kormánypárti képviselők jelentős többségbe kerültek a parlamentben a választások után.
    </p>

    <h3>Akkor mi várható?</h3>
    <hr />
    <p>
      Abban nagyjából mindenki egyetért hogy a parlamenti helyek újraelosztása elmozdíthatja a már többszörösen is holtpontra jutott kilépési folyamatot valamilyen irányba. Az új parlament már el is fogadta a kilépésről szóló törvényjavaslatot, ami azt jelenti, hogy <b>az Egyesült Királyság január 31-én hivatalosan is kilép az EU-ból</b>. Mindez még nem fog nagy változásokat jelenteni az emberek hétköznapjaiban, hiszen <b>előreláthatólag 2020. december 31-ig egy átmeneti időszak veszi kezdetét</b>, amely éppen arra szolgál, hogy a fent is taglalt vitás kérdések (kereskedelmi egyezmények, munkavállalás, stb.) részleteiről megegyezzenek tárgyalófelek.
    </p>
